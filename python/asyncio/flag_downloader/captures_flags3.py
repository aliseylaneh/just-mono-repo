import httpx
import asyncio
from flag_common import DownloadStatus
from http import HTTPStatus
from captures_flags2 import save_flag
from collections import Counter
from pathlib import Path
from tqdm import tqdm
from captures_flags import BASE_URL
from flag_common import main
...
async def download_one(
    ...
    try:
        ...
        async with semaphore:
            country = await get_country(client=client, base_url=base_url, cc=cc)
